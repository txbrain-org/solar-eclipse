...
if [ ! -f $LIBRARY_PATH/libtcl8.6.dylib ]
then 
...
echo "\$(SOURCE_PATH)/genetic_correlation.o \\" >> sources.mk
...
echo "\$(SOURCE_PATH)/print_phi2.o \\" >> sources.mk
echo "\$(SOURCE_PATH)/pedigree_power.o \\" >> sources.mk
echo "" >> sources.mk
...
# FIXME: this is for mac
#echo "$LIBRARY_PATH/libtcl8.6.dylib \\" >> sources.mk
...
echo "FFLAGS=-m64  -O2 -fno-second-underscore -fexceptions -fallow-argument-mismatch" >> Makefile
...
echo ".f.o:" >> Makefile
echo "	$FC_COMPILER -c \$(FFLAGS) -o \$@ \$<" >> Makefile
echo ".c.o:" >> Makefile
...
#echo "	$FC_COMPILER -o \$@  \$(FC_OBJECTS) \$(CXX_OBJECTS) \$(C_OBJECTS) \$(LDFLAGS) \$(LIBRARIES) \$(MKL_LIBS) -Wl,--end-group" >> Makefile
echo "	$FC_COMPILER -o \$@  \$(FC_OBJECTS) \$(CXX_OBJECTS) \$(C_OBJECTS) \$(LDFLAGS) \$(LIBRARIES)" >> Makefile
